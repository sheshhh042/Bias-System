    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('research.department', 'Toursim') }}">Tourism</a>
                <a class="collapse-item" href="{{ route('research.department', 'HospitalityManagment') }}">Hospitality Management</a>
            </div>
        </div>
    </li>
